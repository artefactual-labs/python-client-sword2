...
SWORD2ERRORSBYNAME["TargetOwnerUnknown"] = {
    "name": "TargetOwnerUnknown",
...
SWORD2ERRORSBYNAME["MediationNotAllowed"] = {
    "name": "MediationNotAllowed",
...
SWORD2ERRORSBYNAME["MethodNotAllowed"] = {
...
SWORD2ERRORSBYNAME["MaxUploadSizeExceeded"] = {
...
SWORD2ERRORSBYNAME["UNKNOWNERROR"] = {
    "name": "UNKNOWNERROR",
    "IRI": "",
    ...
    if iri in list(SWORD2ERRORSBYIRI.keys()):
        if code is not None:
            if code in SWORD2ERRORSBYIRI[iri]["codes"]:
                ...
                sworderror_l.error(
                    "Matched '%s' to a known SWORD2 error IRI, but the HTTP response code is NOT one of the IRI's' expected response codes."
                    % iri
                )
